...
"}")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 30, 302, 80))
...
"color: rgb(0, 0, 0);")
        ...
        self.boardNPromoteButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.boardNPromoteButton.setObjectName("boardNPromoteButton")
        self.horizontalLayout1.addWidget(self.boardNPromoteButton)
        self.boardBPromoteButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.boardBPromoteButton.setObjectName("boardBPromoteButton")
        self.horizontalLayout1.addWidget(self.boardBPromoteButton)
        self.boardRPromoteButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.boardRPromoteButton.setObjectName("boardRPromoteButton")
        self.horizontalLayout1.addWidget(self.boardRPromoteButton)
        self.boardQPromoteButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.boardQPromoteButton.setObjectName("boardQPromoteButton")
        self.horizontalLayout1.addWidget(self.boardQPromoteButton)
